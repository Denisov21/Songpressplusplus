...
class SongpressToolbarsMixin:
    ...
    INSERT_TOOLBAR_ITEMS = [
        ...
        ('insertVerse',                       _(u'Unnumbered verse'),                   'tb_insertVerse'),
        ('insertVerseNum',                    _(u'Numbered verse'),                     'tb_insertVerseNum'),
        ('insertChorusBlock',                 _(u'Chorus block'),                       'tb_insertChorusBlock'),
        ('insertChordBlock',                  _(u'Intro chords'),                       'tb_insertChordBlock'),
        ('insertBridge',                      _(u'Bridge {start_bridge}\\{end_bridge}'),'tb_insertBridge'),
        ('insertGrid',                        _(u'Grid'),                               'tb_insertGrid'),
        ...
        ('insertFingering',                   _(u'Fingering {fingering:}'),             'tb_insertFingering'),
        ('insertDefine',                      _(u'Guitar diagram {define:}'),           'tb_insertDefine'),
        ('insertImage',                       _(u'Image {image:}'),                     'tb_insertImage'),
        ('insertTransposerImage',             _(u'Transposer image'),                   'tb_insertTransposerImage'),
        ('insertMusicalSymbol',               _(u'Musical symbol'),                     'tb_insertMusicalSymbol'),
    ]
