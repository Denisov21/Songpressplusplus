...
class SongTokenizer(Tokenizer):
    ...
    #Tokens
    openCurlyToken = TokenType(r'(\{)', 'openCurlyToken')
    closeCurlyToken = TokenType(r'(\})', 'closeCurlyToken')
    ...
    chordToken = TokenType(r'(\[[^]]*)', 'chordToken')
    closeChordToken = TokenType(r'(\])', 'closeChordToken')
