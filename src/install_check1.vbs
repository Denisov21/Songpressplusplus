...
DEPS(8,0) = "pywin32       " : DEPS(8,1) = "pywin32       " : DEPS(8,2) = "308    " : DEPS(8,3) = "999.0"
...
answer = MsgBox(APP_NAME & " " & APP_VERSION & Chr(13) & Chr(13) & _
    ...
    "  2. Installa o aggiorna le dipendenze" & Chr(13) & _
...
MsgBox "Python trovato: " & pythonExe & Chr(13) & Chr(13) & _
    "Le dipendenze verranno installate/aggiornate in background." & Chr(13) & _
...
' Esegue il batch ridotto a icona
oShell.Run "cmd /c """ & batPath & """", 2, True
