...
Function InstallTypePage
  ...
  ; --- Radiobutton: Installazione standard ---
  ${NSD_CreateRadioButton} 10u 10u 280u 14u "$(STR_INSTALL_NORMAL)"
  Pop $hwndNormal
  ${NSD_Check} $hwndNormal

  ${NSD_CreateLabel} 22u 26u 268u 24u "$(STR_INSTALL_NORMAL_DESC)"
  Pop $0
  ; stile WS_DISABLED (0x08000000) per renderlo non cliccabile/grigio come testo descrittivo
  ; lasciamo lo stile default: Label e' gia' non interattiva

  ; --- Separatore visivo ---
  ${NSD_CreateHLine} 10u 54u 280u 1u ""
  Pop $0

  ; --- Radiobutton: Installazione portabile ---
  ${NSD_CreateRadioButton} 10u 60u 280u 14u "$(STR_PORTABLE)"
  Pop $hwndPortable

  ${NSD_CreateLabel} 22u 76u 268u 24u "$(STR_PORTABLE_DESC)"
  Pop $0

  ; --- Separatore visivo ---
  ${NSD_CreateHLine} 10u 104u 280u 1u ""
  Pop $0

  ; --- Checkbox: Associazione estensioni ---
  ${NSD_CreateCheckbox} 10u 110u 280u 14u "$(STR_ASSOC_EXT)"
  Pop $hwndAssoc
