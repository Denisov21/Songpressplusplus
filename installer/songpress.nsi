...
;    plugins\INetC.dll - plugin NSIS per test connessione
; ============================================================
...
Function InstallTypePage
  ...
  ${NSD_CreateLabel} 22u 20u 268u 30u "$(STR_INSTALL_NORMAL_DESC)"
  Pop $0
  ${NSD_CreateHLine} 10u 52u 280u 1u ""
  Pop $0
  ${NSD_CreateRadioButton} 10u 56u 280u 14u "$(STR_PORTABLE)"
  Pop $hwndPortable
  ${NSD_CreateLabel} 22u 72u 268u 30u "$(STR_PORTABLE_DESC)"
  Pop $0
  ${NSD_CreateHLine} 10u 104u 280u 1u ""
  Pop $0
  ${NSD_CreateCheckbox} 10u 108u 280u 14u "$(STR_ASSOC_EXT)"
  Pop $hwndAssoc
  ${NSD_CreateHLine} 10u 124u 280u 1u ""
  Pop $0
  ${NSD_CreateCheckbox} 10u 128u 280u 14u "$(STR_CHECK_NET)"
  Pop $hwndCheckNet
...
;  Richiede plugins\INetC.dll (x86-unicode) nella cartella installer\plugins;  INetC restituisce "OK" se il download ha avuto successo,
