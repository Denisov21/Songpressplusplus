...
```
dist/
└── Songpress++-8.0.4-portable.zip   ← estrai e distribuisci
...
```toml
[project]
version = "8.0.4"   ← aggiorna qui, il resto è automatico
```
...
Quando pubblichi un tag che inizia con `v` (es. `v8.0.4`), il workflow parte da
