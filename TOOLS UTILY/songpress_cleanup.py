...
REG_KEYS = [
    ...
    (r"Software\Classes\.sng",      "Associazione .sng"),
...
REG_VALUES = [
    ...
    (r"Software\Classes\.sng\OpenWithProgids",      "Songpress.crd",       "OpenWithProgids .sng → Songpress.crd"),
...
EXTENSIONS = ["crd", "pro", "chopro", "chordpro", "cho", "tab", "sng"]
    ...
    def _build_ui(self):
        ...
        tk.Label(self,
                 text="Questa funzione rimuove i ProgID legacy e reimporta le\n"
                      "associazioni corrette per .crd .pro .chopro .chordpro .cho .tab .sng.",
